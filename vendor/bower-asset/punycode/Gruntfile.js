module.exports = function (grunt) {
  grunt.initConfig({
    ...
    shell: {
      ...
      "cover-coveralls": {
        command:
          'istanbul cover --verbose --dir "coverage" "tests/tests.js" && cat coverage/lcov.info | coveralls; rm -rf coverage/lcov*',
      },
      "test-narwhal": {
        command:
          'echo "Testing in Narwhal..."; export NARWHAL_OPTIMIZATION=-1; narwhal "tests/tests.js"',
      },
      "test-phantomjs": {
  ...
  grunt.registerTask("test", ["ci", "shell:test-browser"]);

  grunt.registerTask("default", ["uglify", "shell:test-node"]);
};
