...
<div id="demos">
    ...
    <ul>
        <li><a href="/wizard/registration">Registration Wizard&nbsp;&raquo;</a>
            <p>A Four step registration wizard.</p>
            <p>You can return to previous steps either using the "Previous" button or the menu; note that $autoAdvance===TRUE, so if you go back two steps the "Next" button goes to the first uncompleted step.</p>
            <p>You can save your registration by clicking the Save button, and then resume it later by going to the provided URL.</p>
        </li>
        <li><a href="/wizard/quiz">Quiz Wizard&nbsp;&raquo;</a>
            <p>10 General knowledge questions, but you need to be quick with your answers.</p>
            <p>This demonstrates the step timeout feature &ndash; you have 30 seconds to answer each question, and step repetition &ndash; the quiz only has one step.</p>
        </li>
        <li><a href="/wizard/survey">Survey Wizard&nbsp;&raquo;</a>
            <p>A short survey about your pets that demonstrates the Plot-Branching Navigation (PBN) feature of the Wizard Behavior.</p>
            <p>PBN allows the wizard to present different forms depending on the results of previous steps; an "if this then that" mechanism.</p>
            <p>Give different answers to see what happens.</p>
        </li>
    </ul>
