 ...
 * if the {{app\modules\storage\storage\BaseFileSystemStorage}} component is registered which is by default the case when the LUYA
...
class Storage
{
     ...
     *
     * @param integer $imageId The corresponding imageId for the {{\app\modules\storage\models\StorageImage}} Model to remove.
     * @param boolean $cleanup If cleanup is enabled, all other images will be deleted. Even the {{\app\modules\storage\models\StorageFile}} will be removed
     * from the database and filesystem. By default cleanup is disabled and will only remove the provided $imageId itself from {{\app\modules\storage\models\StorageImage}}.
     * @return boolean
     */
     ...
     * @param integer $toFolder The id of the folder the file should be uploaded to, see {{app\modules\storage\storage\BaseFileSystemStorage::findFolders}}
