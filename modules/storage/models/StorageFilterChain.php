...
use app\modules\storage\FilterInterface;
/**
 * This is the model class for table "admin_storage_filter_chain".
 *
 * @property int $id
 * @property int|null $sort_index
 * @property int|null $filter_id
 * @property int|null $effect_id
 * @property string|null $effect_json_values
 */
class StorageFilterChain extends ActiveRecord
{
   ...
   public function init()
   {
    ...
    public function attributeLabels()
    {
        return [
            ...
            'filter_id' => 'Filter ID',
            'effect_id' => 'Effect ID',
            'effect_json_values' => 'Effect Json Values',
        ];
    }
      /**
